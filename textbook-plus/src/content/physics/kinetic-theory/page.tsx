...
export default function KineticTheoryChapter() {
  return (
    <>
      ...
      <Expandable variant="exercise" title="Exercises — molecular nature of matter">
        <h3 className="my-4 text-sm font-extrabold uppercase tracking-wide text-foreground">12.1 — Molecular volume fraction of oxygen</h3>
        <ProblemSolution.Problem>
          <p>
      ...
      <Expandable variant="exercise" title="Exercises — gas laws and the ideal-gas equation">
        <h3 className="my-4 text-sm font-extrabold uppercase tracking-wide text-foreground">12.2 — Molar volume is 22.4 L</h3>
        <ProblemSolution.Problem>
          <p>
        ...
        <h3 className="my-4 text-sm font-extrabold uppercase tracking-wide text-foreground">12.3 — PV/T versus P for oxygen</h3>
        <ProblemSolution.Problem>
          <p>
        ...
        <h3 className="my-4 text-sm font-extrabold uppercase tracking-wide text-foreground">12.4 — Oxygen withdrawn from a cylinder</h3>
        <ProblemSolution.Problem>
          <p>
        ...
        <h3 className="my-4 text-sm font-extrabold uppercase tracking-wide text-foreground">12.5 — Air bubble rising in a lake</h3>
        <ProblemSolution.Problem>
          <p>
        ...
        <h3 className="my-4 text-sm font-extrabold uppercase tracking-wide text-foreground">12.6 — Molecules in a room</h3>
        <ProblemSolution.Problem>
          <p>
      ...
      <Expandable variant="exercise" title="Exercises — kinetic interpretation and rms speed">
        <h3 className="my-4 text-sm font-extrabold uppercase tracking-wide text-foreground">12.7 — Thermal energy of a helium atom</h3>
        <ProblemSolution.Problem>
          <p>
        ...
        <ProblemSolution.Solution>
          <p>Average thermal energy = (3/2)k_B T:</p>
          <p>
        ...
        <h3 className="my-4 text-sm font-extrabold uppercase tracking-wide text-foreground">12.8 — Three vessels: neon, chlorine, UF₆</h3>
        <ProblemSolution.Problem>
          <p>
        ...
        <ProblemSolution.Solution>
          <p>Equal V, T and P ⟹ equal numbers of molecules (Avogadro&rsquo;s law) — <strong>yes</strong>.</p>
          <p>
        ...
        <h3 className="my-4 text-sm font-extrabold uppercase tracking-wide text-foreground">12.9 — rms speed of argon equals helium</h3>
        <ProblemSolution.Problem>
          <p>
        ...
        <ProblemSolution.Solution>
          <p>v_rms ∝ √(T/M). For equal speeds, T_Ar/M_Ar = T_He/M_He with T_He = 273 − 20 = 253 K:</p>
      ...
      <Expandable variant="exercise" title="Exercise — mean free path and collision frequency">
        <h3 className="my-4 text-sm font-extrabold uppercase tracking-wide text-foreground">12.10 — Mean free path of nitrogen at 2 atm</h3>
        <ProblemSolution.Problem>
          <p>
