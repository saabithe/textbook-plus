...
export default function StraightLinesChapter() {
  return (
    <>
      ...
      <FormulaBlock latex="y - y_1 = m(x - x_1)" important />
      <ul>
      ...
      <Expandable title="Example 6 — Point-Slope Form">
        <ProblemSolution problemNumber="Example 6">
          ...
          <ProblemSolution.Solution>
            ...
            />
            <FormulaBlock latex="4x + y + 13 = 0" important />
          </ProblemSolution.Solution>
        </ProblemSolution>
      </Expandable>
      ...
      <FormulaBlock latex="y = mx + c" important />
      <ul>
      ...
      <FormulaBlock latex="Ax + By + C = 0" important />
      <ul>
      ...
      <Expandable title="Examples 13 to 16 — Miscellaneous">
        ...
        <ProblemSolution problemNumber="Example 14">
          ...
          <ProblemSolution.Solution>
            ...
            <FormulaBlock latex="x - y + 1 = 0" important />
          </ProblemSolution.Solution>
        </ProblemSolution>
