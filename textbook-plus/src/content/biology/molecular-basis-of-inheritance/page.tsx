    ...
    <>
      ...
      <ConceptCard title="Nucleotide — Three components">
        <ul className="list-disc pl-5 space-y-1.5">
          <li><strong>Nitrogenous base:</strong> Purines: Adenine (A), Guanine (G); Pyrimidines: Cytosine (C), Uracil (U), Thymine (T). C common to DNA/RNA; T in DNA, U in RNA (5-methyl uracil = thymine).</li>
          <li><strong>Pentose sugar:</strong> Ribose in RNA, deoxyribose in DNA (missing –OH at 2&apos;).</li>
          <li><strong>Phosphate group:</strong> Linked to 5&apos; C of nucleoside via phosphoester linkage.</li>
        </ul>
      </ConceptCard>
      <p><strong>Nucleoside vs Nucleotide:</strong></p>
      <ul>
        <li>Base + sugar (1&apos; C via N-glycosidic linkage) → <strong>nucleoside</strong> (e.g., adenosine, deoxyadenosine, guanosine, cytidine, uridine).</li>
        <li>Nucleoside + phosphate (5&apos; C) → <strong>nucleotide / deoxynucleotide</strong>.</li>
        <li>Two nucleotides via <Highlight color="blue">3&apos;–5&apos; phosphodiester linkage</Highlight> → dinucleotide; many → <strong>polynucleotide chain</strong>.</li>
      </ul>
      <Callout type="note" title="Polarity">
        Polymer has <Highlight color="yellow">5&apos; end</Highlight> (free phosphate at 5&apos; sugar) and <Highlight color="green">3&apos; end</Highlight> (free –OH at 3&apos; sugar). Backbone = sugar-phosphate; bases project inward (Figure 5.1).
      </Callout>
      <FactCard
        title="RNA — Extra –OH"
        definition="Every nucleotide residue in RNA has an additional –OH at 2&apos; position in ribose. Uracil replaces thymine. First identified as acidic substance ‘Nuclein’ by Friedrich Meischer (1869)."
        icon="🧬"
      />
