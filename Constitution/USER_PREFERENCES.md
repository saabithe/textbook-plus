...
| Never cut user derivations | **Never cut down derivations from user-provided notes** — keep every derivation line, formula step, and algebraic expansion the user gives, always and in all future work. Present notes derivations in full even when a shorter textbook version exists. | Sep 2026 |
